...
public class PacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(orbulus.MODID);
	...
	//public static final void sendToAllAround(IMessage message, EntityPlayer player, double range) {
		//PacketDispatcher.sendToAllAround(message, player, player.posX, player.posY, player.posZ, range);
	//}
