...
import orbulus.inventory.ContainerExtended;
import orbulus.inventory.Inventory;
...
public class GuiInventory extends GuiContainer
{
	...
	private static final ResourceLocation iconLocation = new ResourceLocation("orbulus:textures/gui/custom_inventory.png");

	/** Could use IInventory type to be more generic, but this way will save an import... */
	private final Inventory inventory;

	public GuiInventory(EntityPlayer player, InventoryPlayer inventoryPlayer, Inventory 

			inventory1)
	{
		super(new ContainerExtended(player, inventoryPlayer, inventory1));
