...
public class GuiHandler extends GuiContainer
{
	...
	public GuiHandler(EntityPlayer player, InventoryPlayer inventoryPlayer, Inventory 

			inventoryCustom)
	{
		super(new ContainerExtended(player, inventoryPlayer, inventoryCustom));
