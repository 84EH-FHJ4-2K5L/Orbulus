...
public class ExtendedPropsTestItem extends Item
{
	public ExtendedPropsTestItem(int par1) {
		super();
	}
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player)
		...
		if (!world.isRemote)
		{
			 ...
			 */
			EntityPropsExtendedDW props = EntityPropsExtendedDW.get(player);
